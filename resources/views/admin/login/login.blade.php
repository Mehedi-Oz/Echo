                ...
                <div class="card shadow rounded-0 overflow-hidden">
                    <div class="row g-0">
                        <div class="col-lg-6 bg-login d-flex align-items-center justify-content-center">
                            <img src="{{asset('admin-asset')}}/assets/images/error/login-img.jpg" class="img-fluid"
                                 alt="">
                        </div>
                        <div class="col-lg-6">
                            ...
                            <img class="me-2" src="{{asset('admin-asset')}}/assets/images/icons/search.svg" width="16"
                                 alt="">
