    ...
    <div class="sticky-sidebar">
        <div class="sticky-sidebar-content">
            ...
            <div class="author-img">
                <img src="{{asset('front-end-asset')}}/assets/images/author.jpg" alt="">
            </div>
            <div class="author-desc">
                <h5 class="mb-2">Julie Ryan</h5>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugiat consequuntur vel quo, quae aliquam
                    esse
            ...
            <div class="author-posts">
                    ...
                    <div class="row no-gutters">
                        <div class="col-4 col-md-4">
                            <a href="single-layout-one.html">
                                <img src="{{asset('front-end-asset')}}/assets/images/time.jpg" class="card-img" alt="">
                            </a>
                        </div>
                ...
                <div class="card mb-4">
                    <div class="row no-gutters">
                        <div class="col-4 col-md-4">
                            <a href="single-layout-one.html">
                                <img src="{{asset('front-end-asset')}}/assets/images/alone.jpg" class="card-img" alt="">
                            </a>
                        </div>
                        <div class="col-8 col-md-8">
                            <div class="card-body">
                ...
                <div class="card mb-4">
                    <div class="row no-gutters">
                        <div class="col-4 col-md-4">
                            <a href="single-layout-one.html">
                                <img src="{{asset('front-end-asset')}}/assets/images/forest.jpg" class="card-img"
                                     alt="">
                            </a>
                        </div>
                        <div class="col-8 col-md-8">
                ...
                <div class="card mb-4">
                    <div class="row no-gutters">
                        <div class="col-4 col-md-4">
                            <a href="single-layout-one.html">
                                <img src="{{asset('front-end-asset')}}/assets/images/beach-sea.jpg" class="card-img"
                                     alt="">
                            </a>
                        </div>
                        <div class="col-8 col-md-8">
                            <div class="card-body">
                                ...
                                <h5 class="card-title title-font"><a href="single-layout-one.html">Beach is my favourite
                                        place</a>
                                </h5>
                                <div class="author-date">
                                    <a class="date" href="#">
